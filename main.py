...
def onmessage(update,bot:ObigramClient):
    try:
        ...
        if '/start' in msgText:
            start_msg = 'Bot: ➥ @UplodPublicBot soy un bot público Puedo subir a cualquier nube , también puedo descargar ⎙ archivos de ➫ Mega , ➫ Google Drive , ➫ YouTube , ➫ Link directo\n'
